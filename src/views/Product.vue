                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/cart"><a href="shopping-cart.html" class="primary-btn pd-cart">Add To Cart
...
export default {
  ...
  data() {
      return {
          gambar_default: "img/product-single/jeans/jeans-1.jpg",
          thumbs: [
              "img/product-single/jeans/jeans-1.jpg",
              "img/product-single/jeans/jeans-2.jpg",
              "img/product-single/jeans/jeans-3.jpg",
              "img/product-single/jeans/jeans-4.jpg",
          ]
      }
  },
  methods: {
